...
short src_ln0 [] = {
	  0,  13,  16,  18,  19,  21,  21,  20, 
	 23,  23,  23,  17,  25,  25,  25,  15, 
	 28,  28,  30,  31,  32,  11,  34,  11, 
	 34,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "dekker_q4.pml", 1, 24 },
...
{	int j, h = now._nr_pr;
	...
	case 0:	/* process */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->i = ((int)((P0 *)_this)->_pid);
		((P0 *)pptr(h))->j = (1-((int)((P0 *)_this)->_pid));
#ifdef VAR_RANGES
		logval("process:i", ((P0 *)pptr(h))->i);
		logval("process:j", ((P0 *)pptr(h))->j);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (process):\n", pid);
	printf("	byte   i:	%d\n", ((P0 *)pptr(pid))->i);
	printf("	byte   j:	%d\n", ((P0 *)pptr(pid))->j);
		break;
	}
