...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 4: // STATE 10 - _spin_nvr.tmp:8 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC process */
	case 5: // STATE 1 - dekker_q3.pml:13 - [flag[i] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 2 - dekker_q3.pml:16 - [(flag[j])] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!(((int)now.flag[ Index(((int)((P0 *)_this)->j), 2) ])))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 3 - dekker_q3.pml:18 - [((turn==j))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!((((int)now.turn)==((int)((P0 *)_this)->j))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 4 - dekker_q3.pml:19 - [flag[i] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		(trpt+1)->bup.oval = ((int)now.flag[ Index(((int)((P0 *)_this)->i), 2) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 5 - dekker_q3.pml:21 - [((turn!=j))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][5] = 1;
		if (!((((int)now.turn)!=((int)((P0 *)_this)->j))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 6 - dekker_q3.pml:21 - [flag[i] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][6] = 1;
		(trpt+1)->bup.oval = ((int)now.flag[ Index(((int)((P0 *)_this)->i), 2) ]);
		now.flag[ Index(((P0 *)_this)->i, 2) ] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 18 - dekker_q3.pml:28 - [critical = (critical+1)] (0:0:1 - 3)
		IfNotBlocked
		reached[0][18] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 19 - dekker_q3.pml:30 - [critical = (critical-1)] (0:0:1 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		(trpt+1)->bup.oval = ((int)now.critical);
		now.critical = (((int)now.critical)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 20 - dekker_q3.pml:31 - [turn = j] (0:0:1 - 1)
		IfNotBlocked
		reached[0][20] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 21 - dekker_q3.pml:32 - [flag[i] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][21] = 1;
		(trpt+1)->bup.oval = ((int)now.flag[ Index(((int)((P0 *)_this)->i), 2) ]);
		now.flag[ Index(((P0 *)_this)->i, 2) ] = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 25 - dekker_q3.pml:34 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][25] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
