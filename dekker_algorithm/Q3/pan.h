...
#define PanSource	"dekker_q3.pml"
...
#define _nstates1	11	/* atMostOne */
#define minseq1	25
#define maxseq1	34
#define _endstate1	10

#define _nstates0	26	/* process */
#define minseq0	0
#define maxseq0	24
...
#define Pprocess	((P0 *)_this)
typedef struct P0 { /* process */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, j) - 1*sizeof(uchar))
