...
{	Trans *T;
	...
	trans[1][1]	= settr(24,0,6,3,3,"(!((critical<=1)))", 1, 2, 0); /* m: 2 -> 6,0 */
	reached1[2] = 1;
	...
	trans[1][10]	= settr(33,0,0,4,4,"-end-", 0, 3500, 0);
	...
	T = T->nxt	= settr(14,0,2,0,0,"IF", 0, 2, 0);
	...
	trans[0][6]	= settr(5,0,17,10,10,"flag[i] = 1", 1, 2, 0);
	trans[0][8]	= settr(7,0,17,1,0,".(goto)", 0, 2, 0);
	trans[0][12]	= settr(11,0,17,1,0,".(goto)", 0, 2, 0);
	trans[0][9]	= settr(8,0,10,2,0,"else", 0, 2, 0);
	trans[0][10]	= settr(9,0,17,1,0,"(1)", 0, 2, 0);
	trans[0][16]	= settr(15,0,17,1,0,".(goto)", 0, 2, 0);
	trans[0][13]	= settr(12,0,14,2,0,"else", 0, 2, 0);
	trans[0][14]	= settr(13,0,17,1,0,"(1)", 0, 2, 0);
	trans[0][17]	= settr(16,0,18,11,11,"critical = (critical+1)", 1, 2, 0);
	trans[0][18]	= settr(17,0,19,12,12,"critical = (critical-1)", 1, 2, 0);
	trans[0][19]	= settr(18,0,20,13,13,"turn = j", 1, 2, 0);
	trans[0][20]	= settr(19,0,21,14,14,"flag[i] = 0", 1, 2, 0);
	trans[0][23]	= settr(22,0,24,1,0,"break", 0, 2, 0);
	trans[0][24]	= settr(23,0,0,15,15,"-end-", 0, 3500, 0);
	/* np_ demon: */
