...
active proctype elevator() {
	do
	:: atomic {commands ? open -> printf("Elevator: opened doors.\n");}
	:: atomic {commands ? close -> printf("Elevator: closed doors.\n");}
	:: atomic {commands ? up -> assert(closed==true);printf("Elevator: moved up one floor.\n");}
	:: atomic {commands ? down -> assert(closed==true);printf("Elevator: moved down one floor.\n");}
	od
}
