...
#define PanSource	"elevator_Q4.pml"
...
#define _nstates6	7	/* outOfBound */
#define minseq6	255
#define maxseq6	260
#define _endstate6	6

#define _nstates5	14	/* openedDoorCloses */
#define minseq5	242
#define maxseq5	254
#define _endstate5	13

#define _nstates4	11	/* withinLimits */
#define minseq4	232
#define maxseq4	241
#define _endstate4	10

#define _nstates3	201	/* controller */
#define minseq3	32
#define maxseq3	231
#define _endstate3	200

#define _nstates2	9	/* elevator_button_input */
#define minseq2	24
#define maxseq2	31
#define _endstate2	8

#define _nstates1	9	/* floor_button_input */
#define minseq1	16
#define maxseq1	23
#define _endstate1	8

#define _nstates0	17	/* elevator */
#define minseq0	0
#define maxseq0	15
...
typedef struct P5 { /* openedDoorCloses */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* withinLimits */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Pcontroller	((P3 *)_this)
typedef struct P3 { /* controller */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Pelevator_button_input	((P2 *)_this)
typedef struct P2 { /* elevator_button_input */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfloor_button_input	((P1 *)_this)
typedef struct P1 { /* floor_button_input */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Pelevator	((P0 *)_this)
typedef struct P0 { /* elevator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
